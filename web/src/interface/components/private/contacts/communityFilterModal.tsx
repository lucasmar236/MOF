...
const CommunityFilterModal: React.FC<CommunityFilterModalProps> = ({ show, onHide, placeholder }) => {
    ...
    return (
        <Modal show={show} onHide={onHide} centered={true}>
            ...
            <Modal.Footer style={{ border: 'none', gap: '10px' }}>
                ...
                <Button type="submit" style={{ width: "10rem", backgroundColor: "#6CC04F", borderColor: "#6CC04F", borderRadius: "25px" }} onClick={onHide}> 
                    Send
                </Button>
            </Modal.Footer>
        </Modal>
