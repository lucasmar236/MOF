...
import {
  ...
  resetStateCreate,
  userCreateSlice,
} from "../../../../services/redux/createAccount/userCreateSlice";
...
function FormCreateAccount() {
  const { sendUserCreateSuccess, sendUserCreateError, sendUserCreate } =
    useSelector((state: any) => ({
      sendUserCreate: state.userCreateSlice.sendUserCreate,
  ...
  return (
    <>
      <CardLayout
        title="Register"
        text="To use our system, please register with your personal information!"
        imagem=""
      >
        <div>
          <Form
          ...
          >
            ...
            <Row>
              ...
              >
                <Form.Label>
                  <RiAtLine style={{ marginRight: "10px" }} />
                  Username
                </Form.Label>
                <Form.Control
            ...
            <Row className="mb-3">
              ...
              <Form.Group as={Col} controlId="formGridPassword">
                <Form.Label>
                  <RiCake2Line style={{ marginRight: "10px" }} />
                  Date of birth
                </Form.Label>
                <Form.Control
                  type="date"
                ...
                <Col>
                  <Form.Group className="mb-3" id="formGridCheckbox">
                    <Form.Check
                      type="checkbox"
                      label={
                        <p onClick={handleShow} style={{ color: "#0d6efd" }}>
                          Termos de uso
                        </p>
                      }
                    />
        ...
        <Modal.Body>
          ...
          <p>
            <span style={{ color: "rgb(68, 68, 68)" }}>
              Your privacy is important to us. It is Mof policy to respect your
              privacy regarding any information we may collect from you across
              our website, <a href="">Mof</a>, and other sites we own and
              operate.
            </span>
          </p>
          <p>
          ...
          <p>
            <span style={{ color: "rgb(68, 68, 68)" }}>
              ...
              liability for their respective&nbsp;
            </span>
            <a
          ...
          <p>
            <span style={{ color: "rgb(68, 68, 68)" }}>
              ...
              <p>
                <span style={{ color: "rgb(68, 68, 68)" }}>
                  This is the Cookie Policy for Mof, accessible from URL .
                </span>
              </p>
              <p>
                <span style={{ color: "rgb(68, 68, 68)" }}> </span>
              ...
              <p>
                <span style={{ color: "rgb(68, 68, 68)" }}>
                  ...
                  however this may downgrade or br/eak certain elements of the
                  sites functionality.
                </span>
              </p>
              <p>
              ...
              <p>
                <span style={{ color: "rgb(68, 68, 68)" }}>
                  ...
                  settings on your br/owser (see your br/owser Help for how to
          ...
          <p>
            <span style={{ color: "rgb(68, 68, 68)" }}>
              The user undertakes the responsibility to make appropriate use of
              the contents and information offered on the site with enunciative,
              but not imitative, behaviour:
            </span>
          </p>
          <ul>
            <li>
              <span style={{ color: "rgb(68, 68, 68)" }}>
                A) Not to engage in activities that are illegal or contrary to
                good faith and public order;
              </span>
            </li>
            <li>
              <span style={{ color: "rgb(68, 68, 68)" }}>
                B) Not to spread propaganda or content of a racist, xenophobic
                or gambling nature, any type of illegal pornography, terrorist
                claims or against human rights;
              </span>
            </li>
            <li>
              <span style={{ color: "rgb(68, 68, 68)" }}>
                C) Do not cause damage to physical systems (hardware) and
                unattainable (software) of Mof, its suppliers or third parties,
                to introduce or disseminate computer viruses or any other
          ...
          <p>
            <span style={{ color: "rgb(68, 68, 68)" }}>
              This policy is effective as of 29 September 2023 14:06.
            </span>
          </p>
        </Modal.Body>
        <Modal.Footer>
